...
J'ai réalisé le header et le footer pour Sheinez et moi, ce n'était pas très compliqué, si ce n'est qu'elle devait trouvé un moyen pour que le logo soit en format png, mais lors de la conversion de l'image des caractères se faisaient "manger"
